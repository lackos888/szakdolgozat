...
\SubSection{OpenVPN}
A következő táblázatban (\ref{tab:openvpn_apps}) a saját implementációmat, amely OpenVPN Community szervert használ, hasonlítom össze az OpenVPN Access Server-rel.
